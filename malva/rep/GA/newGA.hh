...
// Problem ----------------------------------------------------------------------------
typedef Rarray<tuple<int,int>> Lista;
...
//Solution ----------------------------------------------------------------------------
  ...
  requires class Solution
  {
	public:
		...
		friend Problem& operator>> (Problem& P, Solution& sol);
		...
		void set_solucion_machine(const int index, const int m);
		void swap_tupla(const int a, const int b,const int k,Tupla swap);
		void fromProblem(const Problem &P);

		Tupla & solucion(const int index);
		Rarray <Tupla> & array_solucion();

	private:
		Rarray <Tupla> _solucion;
		const Problem& _pbm;
  };
