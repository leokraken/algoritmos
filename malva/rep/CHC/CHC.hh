/*****************************************************************************************************
*** 	CHC for JSP				developed by Kraken				   ***
*****************************************************************************************************/
...
// Problem ----------------------------------------------------------------------------
typedef Rarray<tuple<int,int>> Lista; //maquina costo
typedef Rarray<Lista> Fila;
typedef Rarray<Fila> Matriz;
typedef tuple<int,int,int,int> Tupla;
typedef Rarray<tuple<int,int,bool>> Row; //job,costo,visitado
typedef Rarray<Row> Orden;
  ...
  requires class Problem
  {
	public:
		...
		int cantidad_maquinas() const;
		int cantidad_trabajos() const;
		int* cantidad_operaciones() const;
		int maquinas_operacion(const int j, const int i) const;

		int get_maquina_index(const int j, const int i, const int index) const;
		int get_operation(const int j, const int m) const;
		int get_costos(const int i, const int j, const int m) const;
		vector<int> get_operaciones_fijas()const;

	private:

		int _dimension;
		int _cantidad_maquinas;
		int _cantidad_trabajos;
		//int **_best_solution; //mejor solucion al problema
		int * _cantidad_operaciones;
		vector<int> _operaciones_fijas;
		Matriz _costos;
  };
...
//Solution ----------------------------------------------------------------------------
  ...
  requires class Solution
  {
	public:
		...
		double calculate_fitness(int* &ordenado) const;
